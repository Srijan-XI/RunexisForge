...
- **ActiveRecord ORM**: Powerful database abstraction layer
- **Rails Generators**: Quick scaffolding for models, controllers, views
- **Asset Pipeline**: Organize and compress CSS/JavaScript
- **Built-in Testing**: Testing framework included
- **Rake Tasks**: Automate common tasks
...
4. **Routes**: Map URLs to controller actions
...
- **Frontend**: ERB, Haml, or JavaScript frameworks
