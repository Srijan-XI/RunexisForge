...
## 🎯 Key Features: Minimalist Lisp, First-class continuations, Lexical scoping, Tail-call optimization, Macro system

## 💡 Use Cases: **Education** (MIT, Berkeley CS courses), **Embedded scripting** (GNU Guile in GIMP, Emacs), **Research**, **Lisp learning**
