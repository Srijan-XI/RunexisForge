...
## 🎯 Key Features: ML-family syntax, Strong static typing, Pattern matching, Functional + imperative, Native compilation

## 💡 Use Cases: **Compilers** (Rust, Flow, Hack), **Finance** (Jane Street trading), **Formal verification**, **Static analysis** (Facebook Infer)
