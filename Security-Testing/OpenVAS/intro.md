...
- **Credentials Support**: Authenticated scanning for accurate results
- **Compliance Checking**: PCI-DSS, GDPR, etc.
- **Task Automation**: Schedule regular scans
- **Asset Management**: Track scanned systems
...
4. **NVT Database**: Vulnerability test database
